...
const functionJsonPath = (functionPath) => path_1.default.join(functionPath, 'function.json');
exports.functionJsonPath = functionJsonPath;
const isFunction = (functionPath) => fs_extra_1.default.pathExistsSync(functionJsonPath(functionPath));
exports.isFunction = isFunction;
const fetchFunction = (functionPath) => __awaiter(void 0, void 0, void 0, function* () {
