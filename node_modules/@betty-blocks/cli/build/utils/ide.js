...
class IDE {
    constructor(host, zone) {
        ...
        this.fusionAuth = new fusionAuth_1.default(this.host, this.zone, () => __awaiter(this, void 0, void 0, function* () { return this.relogin(); }));
    }
    ...
    request(method, requestPath, options, label) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { statusCode } = yield this.webhead[method](`${this.host}/api/${requestPath}`, options);
            if (spinner) {
    ...
    ensureLogin() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.loggedIn)
                return;
            yield this.webhead.get(this.host);
