...
class FusionAuth {
    ...
    upload(uuid, zipFile) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { statusCode } = yield this.webhead.post(`${this.builderApiURL()}/artifacts/actions/${uuid}/functions`, {
                headers: {
                    Authorization: `Bearer ${this.jwt()}`,
                },
    ...
    request(method, urlPath, options) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.webhead.url) {
                yield this.webhead.get(this.fusionAuthURL());
            }
