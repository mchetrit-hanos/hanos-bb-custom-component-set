...
const resolveMissingFunction = (groomed, metaData, name, defaultInputVariables) => __awaiter(void 0, void 0, void 0, function* () {
    const { replace } = yield prompts_1.default({
        type: 'toggle',
        name: 'replace',
    ...
    if (replace) {
        ...
        if (choices.length === 1) {
            const confirm = yield prompts_1.default({
                type: 'confirm',
                name: 'value',
            ...
            replacedFunction = (yield prompts_1.default({
                type: 'select',
                name: 'value',
                message: 'Replace',
        ...
        const { returnType, inputVariables } = yield prompts_1.default([
            {
                type: 'select',
                name: 'returnType',
        ...
        groomed[name] = {
            returnType,
            inputVariables: inputVariables.split(/(\s|,)/).reduce((variables, variable) => {
                if (variable.length) {
...
const storeCustomFunctions = (ide, metaData, bumpRevision) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Object.keys(metaData).reduce((promise, name) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return ide[method](`custom_functions/${id || 'new'}`, { json: { record: params } }, `${action} custom function "${replace || name}" ...`);
