...
const publishAppFunctions_1 = __importDefault(require("./utils/publishAppFunctions"));
const publishCustomFunctions_1 = __importDefault(require("./utils/publishCustomFunctions"));
/* process arguments */
commander_1.default
...
if (fs_extra_1.default.existsSync(path_1.default.join(workingDir, '.app-functions'))) {
    publishAppFunctions_1.default(host);
}
else {
