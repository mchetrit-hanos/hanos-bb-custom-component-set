          ...
          onSave={() => {
            ...
            properties.forEach(property => {
              newPrefab.structure[0].descendants.push({
                name: 'DataTableColumnWithToolTip',
                options: [
                  {
                    value: true,
  ...
  structure: [
    {
      ...
      options: [
        ...
        {
          label: 'Show selected count at the ... of the text',
          key: 'selectedRowCountLocationInText',
          type: 'CUSTOM',
          value: 'start',
          configuration: {
            as: 'BUTTONGROUP',
        ...
        {
          type: 'VARIABLE',
          label: 'Selected row count text',
          key: 'selectedRowCountText',
          value: ['selected rows'],
          configuration: {
            condition: {
              type: 'SHOW',
        ...
        },
        {
          ...
          key: 'alternateRowColors',
          value: false,
        },
        {
          type: 'COLOR',
          label: 'Background color odd rows',
          key: 'oddBackgroundColor',
          value: 'Transparent',
          configuration: {
            condition: {
              type: 'SHOW',
        ...
        {
          type: 'COLOR',
          label: 'Background color even rows',
          key: 'evenBackgroundColor',
          value: 'Transparent',
          configuration: {
            condition: {
              type: 'SHOW',
